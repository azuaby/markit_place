		             ...
		             echo '<thead>';
			             ...
			             foreach($getcntryval as $key=>$country_det){
							 ...
							 echo '<tr id="dcntry_'.$id.'">';
								...
								echo '<td>'; 
						?>
								<a href="<?php echo SITE_URL.'admin/edit/countries/'.$id;?> "><span class="btn btn-info"><i class="icon-edit"></i></span></a>
  								<a href="#" onclick='dcntry_delete("<?php echo $id; ?>")'><span class="btn btn-danger"><i class="icon-trash"></i></span></a>
  							    <?php
						        echo '<td>';
							 echo '</tr>';
						}
