	...
	if(($ext != '.JPG' && $ext != '.PNG' && $ext != '.JPEG' && $ext != '.GIF' && $ext != '.jpg' && $ext != '.png' && $ext != '.jpeg' && $ext != '.gif') || $fsize > 200*1024*1024){
		...
		if(isset($ftmp)){
			...
			if ($ext != '.png' && $ext != '.PNG'){
				...
				$originalImage = $ftmp; $outputImage = $finalPath."logo.png"; $quality = 9;
				...
				move_uploaded_file($ftmp,$finalPath."logo.png");
				$newname = "logo.png";
			}
			...
			$resizeObj = new resize($finalPath."logo.png");
				
			// *** 2) Resize image (options: exact, portrait, landscape, auto, crop)
			$resizeObj -> resizeImage(139, 25, 'auto');
				
			// *** 3) Save image
			$resizeObj -> saveImage($finalPath."logo.png", 100);
			chmod($finalPath."logo.png", 0644);
			$resizeObj = "";
			...
			// *** 2) Resize image (options: exact, portrait, landscape, auto, crop)
			$resizeObj -> resizeImage(139, 25, 'exact');
