...
if(isset($_GET['uploaded'])){
	//echo $_GET['uploaded'];die;
	echo '<div id="if-success" style="">';
	echo '<div class="center">';
	echo '<img src="media/avatars/thumb150/usrimg.jpg">';
	
	echo '<p>Image has been saved your account</p>';
	echo '<a class="f-button" target="_blank" href="'.$_GET['uploaded'].'" onclick="closebookmarklet();">See the Item</a>';
	echo '</div>';
	echo '</div>';
