...
javascript: (function (e, a, g, h, f, c, b, d) {
  ...
  var BIG_DIMENSION = 400,      // min width of image that counts as big
      THUMBNAIL_SIZE = 300;
  ...
  var popup = aElem("div", {
      ...
      style:  "position:absolute;background:#aaa;padding:4px;border-radius:4px;padding:8px;border:2px solid #888;z-index:999;"
    }, [
    aElem("p", {
    ...
    aElem("ul", {}, $.map(bigImages, function(img,i) {
      return aElem("li", {}, [
