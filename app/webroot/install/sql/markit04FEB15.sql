...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 04, 2015 at 05:43 PM
...
--
-- Table structure for table `fc_allareas`
--

CREATE TABLE IF NOT EXISTS `fc_allareas` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `fc_allareas`
--

INSERT INTO `fc_allareas` (`id`, `state_id`, `area`) VALUES
(1, 1, 'Junagadh'),
(2, 1, 'Somnath'),
(3, 1, 'Talala'),
(4, 2, 'Jaipur'),
...
--
-- Table structure for table `fc_allowed_countries`
--

CREATE TABLE IF NOT EXISTS `fc_allowed_countries` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `fc_allowed_countries`
--

INSERT INTO `fc_allowed_countries` (`id`, `country_id`, `code`, `country`) VALUES
(1, 100, 'IN', 'India'),
(2, 117, 'KW', 'Kuwait'),
(3, 230, 'AE', 'United Arab Emirates'),
(4, 193, 'SA', 'Saudi Arabia'),
(1, 100, 'IN', 'India'),
(2, 117, 'KW', 'Kuwait'),
(3, 230, 'AE', 'United Arab Emirates'),
(4, 193, 'SA', 'Saudi Arabia');
...
--
-- Table structure for table `fc_allstates`
--

CREATE TABLE IF NOT EXISTS `fc_allstates` (
  `id` int(11) NOT NULL,
  `country_id` int(11) NOT NULL,
...
--
-- Dumping data for table `fc_allstates`
--

INSERT INTO `fc_allstates` (`id`, `country_id`, `code`, `state`) VALUES
(1, 100, 'GJ', 'Gujarat'),
(2, 100, 'GJ', 'Rajasthan'),
(3, 100, 'GJ', 'Delhi'),
(4, 117, 'GJ', 'Hawally'),
...
INSERT INTO `fc_carts` (`id`, `user_ip`, `user_id`, `item_id`, `payment_status`, `quantity`, `size_options`, `created_at`, `modified_at`) VALUES
(483, NULL, 136, 14, 'progress', 1, NULL, '2015-01-18 12:03:16', '2015-01-18 14:03:16'),
(484, NULL, 139, 11, 'progress', 1, NULL, '2015-01-21 03:47:21', '2015-01-21 13:47:21'),
(485, NULL, 139, 14, 'progress', 1, NULL, '2015-01-21 03:49:01', '2015-01-21 13:49:01'),
(486, NULL, 2, 13, 'progress', 1, NULL, '2015-01-25 03:36:37', '2015-01-25 13:36:37'),
(487, NULL, 139, 13, 'progress', 1, NULL, '2015-01-25 03:41:30', '2015-01-25 13:41:30');
...
`id` int(11) NOT NULL,
  ...
  `category_vrintype` int(11) NOT NULL,
...
INSERT INTO `fc_categories` (`id`, `category_name`, `category_urlname`, `category_parent`, `category_vrintype`, `category_sub_vrintype`, `category_del_type`, `category_sub_parent`, `created_by`, `created_at`, `modified_at`) VALUES
(1, 'Men', 'men', 0, 0, '', '', 0, 1, '2013-07-31 11:03:46', '0000-00-00 00:00:00'),
(2, 'Women', 'women', 0, 0, '', '', 0, 1, '2013-07-31 11:03:53', '0000-00-00 00:00:00'),
(3, 'Home', 'home', 0, 0, '', '', 0, 1, '2013-07-31 11:03:59', '0000-00-00 00:00:00'),
(4, 'Clothes', 'clothes', 1, 0, '', '', 0, 1, '2013-07-31 11:04:13', '0000-00-00 00:00:00'),
(7, 'Shirts', 'shirts', 1, 0, '', '', 4, 1, '2013-07-31 11:06:03', '2013-07-31 09:47:13'),
(9, 'Shoes', 'shoes', 1, 0, '', '', 0, 1, '2013-07-31 11:06:41', '0000-00-00 00:00:00'),
(10, 'Casuals', 'casuals', 1, 0, '', '', 9, 1, '2013-07-31 11:06:41', '0000-00-00 00:00:00'),
(11, 'Clothe', 'clothe', 2, 0, '', '', 0, 1, '2013-07-31 12:19:31', '0000-00-00 00:00:00'),
(12, 'Jeans', 'jeans', 2, 0, '', '', 11, 1, '2013-07-31 12:19:32', '0000-00-00 00:00:00'),
(13, 'Interiors', 'interiors', 3, 0, '', '', 0, 1, '2013-07-31 12:23:44', '0000-00-00 00:00:00'),
(14, 'Room', 'room', 3, 0, '', '', 13, 1, '2013-07-31 12:23:44', '0000-00-00 00:00:00'),
(15, 'Kitchen', 'kitchen', 3, 0, '', '', 0, 1, '2013-07-31 12:24:21', '0000-00-00 00:00:00'),
(16, 'Things', 'things', 3, 0, '', '', 15, 1, '2013-07-31 12:24:22', '0000-00-00 00:00:00'),
(17, 'Bags', 'bags', 2, 0, '', '', 0, 1, '2013-07-31 13:29:28', '0000-00-00 00:00:00'),
(18, 'Hand Bag', 'hand-bag', 2, 0, '', '', 17, 1, '2013-07-31 13:29:29', '0000-00-00 00:00:00'),
(49, 'Pant', 'pant', 1, 0, 'Size', 'regular', 0, 1, '2015-01-17 18:43:08', '0000-00-00 00:00:00'),
(50, 'Women', 'women', 2, 0, '35 X 50', 'special', 0, 1, '2015-01-17 19:02:40', '0000-00-00 00:00:00');
...
--
-- Dumping data for table `fc_deliverycountries`
--

INSERT INTO `fc_deliverycountries` (`id`, `dcountry`, `dcountrycode`, `darea`, `dcurrency`, `dzone`) VALUES
(1, 'Kuwait', 117, '', 'K.D.', 'A');
...
--
-- Dumping data for table `fc_delivery_charges`
--

INSERT INTO `fc_delivery_charges` (`id`, `name`, `regulr_chrge`, `expres_chrge`) VALUES
(1, 'A', 1, 2);
...
INSERT INTO `fc_forexrates` (`id`, `country_code`, `currency_code`, `currency_symbol`, `country_name`, `currency_name`, `price`, `status`, `cdate`) VALUES
(23, NULL, 'KWD', 'K.D.', '', 'Kuwaiti Dinar', '1', 'enable', '2015-01-18 14:27:51'),
(24, NULL, 'SAR', 'Riyal', '', 'Saudi Riyal', '12.76', 'enable', '2015-01-18 14:44:47');
...
INSERT INTO `fc_groupgiftuserdetails` (`id`, `user_id`, `item_id`, `recipient`, `name`, `image`, `address1`, `address2`, `country`, `state`, `city`, `zipcode`, `telephone`, `itemcost`, `itemsize`, `itemquantity`, `shipcost`, `total_amt`, `balance_amt`, `title`, `description`, `notes`, `status`, `c_date`) VALUES
(26, 139, 14, 'nburashed', 'Naser Bader Burashed', 'usrimg.jpg', 'Block 2, St 25, House 20', 'house 20', '117', 'Kuwait', 'Rawda', 73302, 97223280, '2500', '', 1, '120', '2620', '2620', 'Naser''s Birthday ', 'Happy Birthday', 'Gift wrap', 'Active', 1421848721);
...
(1064, 139, 11, '2015-01-21 13:47:44'),
(1065, 139, 14, '2015-01-21 13:48:20'),
(1066, 139, 12, '2015-01-22 17:14:37'),
(1067, 139, 13, '2015-01-25 13:41:10');
...
(125, 139, 'Naser list', '["14"]', 1, '2015-01-21 03:48:32');
...
INSERT INTO `fc_items` (`id`, `user_id`, `shop_id`, `item_title`, `item_title_url`, `item_description`, `shop_sec`, `recipient`, `occasion`, `style`, `tags`, `materials`, `price`, `quantity`, `quantity_sold`, `category_id`, `super_catid`, `sub_catid`, `item_made_it`, `item_for_what`, `item_when_make`, `variation_propty_1`, `scale_size_1`, `offer_options_1`, `variation_propty_2`, `scale_size_2`, `offer_options_2`, `ship_from_country`, `processing_time`, `processing_min`, `processing_max`, `processing_option`, `size_options`, `status`, `created_on`, `modified_on`, `item_color`, `item_color_method`, `fav_count`, `bm_redircturl`, `videourrl`, `featured`, `comment_count`, `report_flag`) VALUES
(1, 2, 1, 'Top Coat', 'top-coat', 'A royal look coat', NULL, '["1","6"]', 0, NULL, NULL, NULL, 250, 5, NULL, 1, 4, 7, '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, 38, '3w', NULL, NULL, NULL, NULL, 'publish', '2013-07-31 06:28:32', '2013-07-31 11:26:02', '["SILVER","BLACK","GOLD","BROWN","WHITE"]', 0, 0, '', NULL, 0, 0, ''),
(2, 2, 1, 'Casual T-shirt', 'casual-t-shirt', 'A good lookin tshirt', NULL, '["7","3","2"]', 0, NULL, NULL, NULL, 130, 50, NULL, 1, 4, 7, '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, 38, '4d', NULL, NULL, NULL, NULL, 'publish', '2013-07-31 06:30:41', '2013-07-31 11:26:03', '["WHITE","SILVER","GOLD","BROWN"]', 0, 0, '', NULL, 0, 0, ''),
(3, 2, 1, 'Over coat', 'over-coat', 'Good looking', NULL, '["7","3","2"]', 0, NULL, NULL, NULL, 140, 6, NULL, 1, 4, 7, '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, 38, '2ww', NULL, NULL, NULL, NULL, 'publish', '2013-07-31 06:33:15', '2013-07-31 11:26:04', '["BROWN","SILVER","BLACK","GOLD","PURPLE"]', 0, 0, '', NULL, 0, 0, ''),
(4, 2, 1, 'Casual shoes', 'casual-shoes', 'A pair of trendy casual shoes', NULL, '["7","3","2","1","6"]', 0, NULL, NULL, NULL, 230, 25, NULL, 1, 9, 10, '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, 89, '3d', NULL, NULL, NULL, NULL, 'publish', '2013-07-31 06:44:51', '2013-07-31 11:26:04', '["WHITE","BLACK"]', 0, 0, '', NULL, 0, 0, ''),
(5, 2, 1, 'Short Jean', 'short-jean', 'Short Jean by Deniim', NULL, '["7","3","2","6"]', 1, NULL, NULL, NULL, 240, 20, NULL, 2, 11, 12, '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, 100, '4w', NULL, NULL, NULL, NULL, 'publish', '2013-07-31 06:50:44', '2013-07-31 11:26:05', '["WHITE","BROWN","SILVER","SKY_BLUE","PURPLE"]', 0, 0, '', NULL, 0, 0, ''),
(6, 2, 1, 'Jean Tops', 'jean-tops', 'Jean Tops with dark color', NULL, '["7","3","2","6"]', 1, NULL, NULL, NULL, 120, 30, NULL, 2, 11, 12, '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, 156, '4w', NULL, NULL, NULL, NULL, 'publish', '2013-07-31 06:52:40', '2013-07-31 11:26:05', '["BLACK","SILVER","BROWN","GOLD"]', 0, 0, '', NULL, 0, 0, ''),
(7, 2, 1, 'Modern Light', 'modern-light', 'A Modern sealing light which movable', NULL, '["1","4","6"]', 0, NULL, NULL, NULL, 500, 5, NULL, 3, 13, 14, '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, 97, '4d', NULL, NULL, NULL, NULL, 'publish', '2013-07-31 06:56:05', '2013-07-31 11:26:06', '["PURPLE","SKY_BLUE","BLACK","BLUE","BROWN"]', 0, 0, '', NULL, 0, 0, ''),
(8, 2, 1, 'Natural Tea pad', 'natural-tea-pad', 'A Natural Looking Tea pad', NULL, '["9","1","4"]', 1, NULL, NULL, NULL, 50, 8, NULL, 3, 15, 16, '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, 100, '3d', NULL, NULL, NULL, NULL, 'publish', '2013-07-31 06:57:31', '2013-07-31 11:26:07', '["GOLD","SILVER","BROWN","BLACK"]', 0, 0, '', NULL, 0, 0, ''),
(9, 2, 1, 'Chips and sauce container', 'chips-and-sauce-container', 'A combo container for both', NULL, '["9","1","4"]', 1, NULL, NULL, NULL, 80, 5, NULL, 3, 15, 16, '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, 100, '3d', NULL, NULL, NULL, NULL, 'publish', '2013-07-31 07:53:40', '2013-07-31 11:26:07', '["BROWN","GOLD","SILVER","BLACK"]', 0, 0, '', NULL, 0, 0, ''),
(10, 2, 1, 'Fish Bowl', 'fish-bowl', 'A classic fish bowl', NULL, '["8","5"]', 0, NULL, NULL, NULL, 40, 20, NULL, 3, 13, 14, '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, 100, '3d', NULL, NULL, NULL, NULL, 'publish', '2013-07-31 07:55:00', '2013-07-31 11:26:08', '["BLACK","BROWN","SKY_BLUE","PURPLE"]', 0, 0, '', NULL, 0, 0, ''),
(11, 2, 1, 'Leaky wall mount lamp', 'leaky-wall-mount-lamp', 'A designer wall mount lamp', NULL, '["9","1","4"]', 0, NULL, NULL, NULL, 15, 12, NULL, 3, 13, 14, '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, 100, '3d', NULL, NULL, NULL, NULL, 'publish', '2013-07-31 07:58:25', '2015-01-21 13:47:44', '["SILVER"]', 0, 1, '', NULL, 0, 0, ''),
(12, 2, 1, 'Bag', 'bag', 'A stylish long bag', NULL, '["7","3","2","5","6"]', 1, NULL, NULL, NULL, 60, 10, NULL, 2, 17, 18, '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, 100, '4d', NULL, NULL, NULL, NULL, 'publish', '2013-07-31 08:00:32', '2015-01-22 17:14:37', '["SILVER","WHITE"]', 0, 1, '', NULL, 0, 0, ''),
(13, 2, 1, 'Globe', 'globe', 'Silver stand globe', NULL, '["2","9","4"]', 0, NULL, NULL, NULL, 30, 20, NULL, 3, 13, 14, '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, 100, '4d', NULL, NULL, NULL, NULL, 'publish', '2013-07-31 08:02:00', '2015-01-25 13:41:10', '["SILVER","WHITE","PURPLE","SKY_BLUE"]', 0, 1, '', NULL, 0, 0, ''),
(14, 2, 1, 'Fake pool', 'fake-pool', 'Fake pool to make your lively', NULL, '["2","9","4","6"]', 0, NULL, NULL, NULL, 2500, 5, NULL, 3, 13, 14, '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, 117, '3w', NULL, NULL, NULL, NULL, 'publish', '2013-07-31 08:03:57', '2015-01-21 13:49:28', '["SKY_BLUE","PURPLE","BROWN","BLACK"]', 0, 1, '', NULL, 0, 1, ''),
(15, 2, 1, 'Printed T-shirt', 'printed-t-shirt', '100% DOUCHE printed t-shirt', NULL, '["7","3","2","6"]', 0, NULL, NULL, NULL, 80, 20, NULL, 1, 4, 7, '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, 100, '4d', NULL, NULL, NULL, NULL, 'draft', '2013-07-31 08:06:56', '2015-01-21 07:28:26', '["BROWN","WHITE","SILVER","GOLD"]', 0, 0, '', NULL, 0, 0, '');
...
(1, 1, 38, '25', '23', NULL, '2013-07-31 06:28:32'),
(2, 1, 100, '30', '25', NULL, '2013-07-31 06:28:32'),
(3, 2, 38, '25', '20', NULL, '2013-07-31 06:30:42'),
(4, 2, 100, '35', '32', NULL, '2013-07-31 06:30:42'),
(5, 2, 0, '50', '42', NULL, '2013-07-31 06:30:42'),
(6, 3, 38, '25', '20', NULL, '2013-07-31 06:33:15'),
(7, 3, 100, '40', '30', NULL, '2013-07-31 06:33:15'),
(8, 4, 89, '24', '20', NULL, '2013-07-31 06:44:51'),
(9, 4, 100, '30', '24', NULL, '2013-07-31 06:44:51'),
(10, 4, 0, '50', '45', NULL, '2013-07-31 06:44:51'),
(11, 5, 100, '24', '20', NULL, '2013-07-31 06:50:44'),
(12, 5, 0, '50', '48', NULL, '2013-07-31 06:50:44'),
(13, 6, 156, '40', '30', NULL, '2013-07-31 06:52:40'),
(14, 6, 100, '25', '24', NULL, '2013-07-31 06:52:40'),
(15, 6, 6, '50', '48', NULL, '2013-07-31 06:52:40'),
(16, 7, 97, '80', '70', NULL, '2013-07-31 06:56:05'),
(17, 7, 100, '50', '45', NULL, '2013-07-31 06:56:05'),
(18, 7, 0, '100', '80', NULL, '2013-07-31 06:56:05'),
(19, 8, 100, '20', '15', NULL, '2013-07-31 06:57:31'),
(20, 8, 0, '25', '15', NULL, '2013-07-31 06:57:31'),
(21, 9, 100, '15', '10', NULL, '2013-07-31 07:53:40'),
(22, 9, 0, '25', '20', NULL, '2013-07-31 07:53:40'),
(23, 10, 100, '10', '8', NULL, '2013-07-31 07:55:01'),
(24, 10, 0, '20', '12', NULL, '2013-07-31 07:55:01'),
(25, 11, 100, '5', '4', NULL, '2013-07-31 07:58:25'),
(26, 11, 0, '8', '6', NULL, '2013-07-31 07:58:25'),
(27, 12, 100, '18', '15', NULL, '2013-07-31 08:00:32'),
(28, 12, 0, '24', '20', NULL, '2013-07-31 08:00:32'),
(29, 13, 100, '10', '8', NULL, '2013-07-31 08:02:00'),
(30, 13, 0, '15', '12', NULL, '2013-07-31 08:02:00'),
(31, 14, 117, '120', '100', NULL, '2013-07-31 08:03:57'),
(32, 14, 100, '80', '75', NULL, '2013-07-31 08:03:57'),
(33, 14, 0, '150', '130', NULL, '2013-07-31 08:03:57'),
(34, 15, 100, '30', '25', NULL, '2013-07-31 08:06:56'),
(35, 15, 0, '35', '30', NULL, '2013-07-31 08:06:56');
...
INSERT INTO `fc_shops` (`id`, `user_id`, `shop_name`, `shop_title`, `shop_banner`, `shop_announcement`, `shop_message`, `shop_address`, `shop_latitude`, `shop_longitude`, `welcome_message`, `payment_policy`, `shipping_policy`, `refund_policy`, `additional_info`, `seller_info`, `phone_no`, `paypal_id`, `seller_status`, `created_on`, `item_count`, `follow_count`) VALUES
(1, 2, 'Demo', 'Demo User', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '9999999999', 'demouser@paypal.com', 1, '2015-01-20 10:49:11', 0, 0),
(138, 136, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', 0, '2015-01-18 13:31:01', 0, 0),
(139, 138, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', 0, '2015-01-20 13:32:35', 0, 0),
(140, 139, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', 0, '2015-01-21 13:45:19', 0, 0);
...
(1, 'Markit Beta', 'Simplit Social eCommerce', 'Markit', 'Markit', 'yes', 'yes', 'noreply@markit.com.kw', 'noreply@markit.com.kw', 'Markit', 'noreply@markit.com.kw', 'noreplyhitasoft', 'enable', 465, '2015-01-18 15:34:12', '', '', 'admin@simplit.co', '123456', 'Markit', 'Markit''D', 'logo.png', 'fantacylike.png', 'sandbox', 'ali_zuaby@hotmail.com', '{"profile_image_view":"square","credit_amount":"23"}', '{"language":"eng"}', '{"title":"FANTACY GIFT CARD","description":"Markit Gift card is the Feature which is used for the User, User can buy send receive the gift card to the friends, And the User can receive the Gift card code and use for the purchase.","amounts":"10,20,30,50,100,1000,1008,2000,5000,10000","image":"1403790138.jpg","time":1403790268}', '{"paymentMode":"paypalnormal","apiUserId":null,"apiPassword":null,"apiSignature":null,"apiApplicationId":null}', NULL, 'enable', 'Powered by <a href="http://www.simplit.co/">Simpl!t Co</a>', 'Markit Social eCommerce', 'yes');
...
INSERT INTO `fc_states` (`id`, `country_id`, `code`, `state`) VALUES
(3, 2, '', 'Kuwait City (capital)'),
(2, 1, '', 'Ahemadabad'),
(4, 1, '', 'Rajasthan');
...
(48, 139, 'Home', 'Naser Bader Burashed', 'Block 2, St 25, House 20', '', 'Rawda', 'Kuwait', 'Kuwait', 73302, 97223280, 117),
(49, 2, 'my office', 'ali zuaby', 'dasman', '', 'sharq', 'no', 'Kuwait', 13037, 22400011, 117);
...
INSERT INTO `fc_users` (`id`, `username`, `username_url`, `first_name`, `last_name`, `password`, `email`, `mobile`, `area`, `areacode`, `telephone`, `block`, `street`, `avenue`, `bilding`, `floor`, `aprtmnt`, `country`, `countrycode`, `state`, `city`, `address1`, `address2`, `website`, `birthday`, `age_between`, `user_level`, `user_status`, `profile_image`, `location`, `about`, `created_at`, `joined_date`, `modified_at`, `login_type`, `facebook_id`, `token_key`, `secret_key`, `twitter_id`, `twitter`, `google_id`, `referrer_id`, `credit_total`, `refer_key`, `gender`, `user_address`, `last_login`, `activation`, `subs`, `someone_follow`, `someone_show`, `someone_cmnt_ur_things`, `your_thing_featured`, `someone_mention_u`, `push_notifications`, `featureditemid`, `defaultshipping`, `user_api_details`, `admin_menus`) VALUES
(1, 'Admin', 'admin', 'admin', 'admin', '4245999507644fc247980e3cc7dd19940c6c6bfc', 'admin@simplit.co', '', '', 0, 0, '', '', '', '', '', '', '', 0, '', '', '', '', '', '', '', 'god', 'enable', '', NULL, NULL, '2013-02-28 12:02:24', '2013-03-15', '2013-02-28 12:02:24', 'normal', NULL, NULL, NULL, 0, '', NULL, '0', NULL, '', 'male', NULL, '2015-02-04 03:08:52', 1, 1, 1, 0, 0, 0, 0, '', 0, 0, '', ''),
(2, 'demo', 'demo', 'Demo', NULL, '4245999507644fc247980e3cc7dd19940c6c6bfc', 'demo@simplit.co', '', '', 0, 0, '', '', '', '', '', '', '', 0, '', '', '', '', '', '', '', 'normal', 'enable', '', NULL, NULL, '2013-07-31 05:25:11', '0000-00-00', '2013-07-31 08:55:11', 'normal', NULL, NULL, NULL, 0, '', NULL, '0', NULL, 'NbHE953O', NULL, NULL, '2015-01-25 03:34:38', 1, 1, 1, 0, 0, 0, 0, '', 0, 49, '', ''),
(136, 'azuaby', 'azuaby', 'ali', 'zuaby', '4245999507644fc247980e3cc7dd19940c6c6bfc', 'ali@zuaby.net', '', '', 0, 0, '', '', '', '', '', '', '', 0, '', '', '', '', '', '', '', 'normal', 'enable', '', NULL, NULL, '2015-01-18 11:31:01', '0000-00-00', '2015-01-18 13:31:01', 'normal', NULL, NULL, NULL, 0, '', NULL, '0', NULL, '08OPMf09', NULL, NULL, '2015-01-18 11:31:16', 1, 1, 1, 0, 0, 0, 0, '', 0, 0, '', ''),
(138, 'markit', 'markit', 'markit', NULL, '4245999507644fc247980e3cc7dd19940c6c6bfc', 'markit@markit.com.kw', '', '', 0, 0, '', '', '', '', '', '', '', 0, '', '', '', '', '', '', '', 'god', 'enable', '', NULL, NULL, '2015-01-20 03:32:34', '0000-00-00', '2015-01-20 13:32:34', 'normal', NULL, NULL, NULL, 0, '', NULL, '0', NULL, 'e692N284', NULL, NULL, '2015-01-25 03:46:37', 1, 1, 1, 0, 0, 0, 0, '', 0, 0, '', ''),
(139, 'nburashed', 'nburashed', 'Naser Burashed', NULL, '4245999507644fc247980e3cc7dd19940c6c6bfc', 'sec60@hotmail.com', '', '', 0, 0, '', '', '', '', '', '', '', 0, '', '', '', '', '', '', '', 'normal', 'enable', '', NULL, NULL, '2015-01-21 03:45:19', '0000-00-00', '2015-01-21 13:45:19', 'normal', NULL, NULL, NULL, 0, '', NULL, '0', NULL, 'aOJCc1bH', NULL, NULL, '2015-01-25 03:36:12', 1, 1, 1, 0, 0, 0, 0, '', 0, 48, '', '');
...
--
-- Indexes for table `fc_deliverycountries`
--
ALTER TABLE `fc_deliverycountries`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `fc_delivery_charges`
--
ALTER TABLE `fc_delivery_charges`
 ADD PRIMARY KEY (`id`);
...
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fc_deliverycountries`
--
ALTER TABLE `fc_deliverycountries`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `fc_delivery_charges`
--
ALTER TABLE `fc_delivery_charges`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `fc_invoiceorders`
MODIFY `invoiceorderid` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `fc_tempaddresses`
MODIFY `shippingid` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=50;
--
...
--
ALTER TABLE `fc_users`
MODIFY `id` int(32) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=140;
--
