  ...
  <!--<![endif]-->
    ...
    <div class="sidebar-nav">
        ...
        <ul id="news-menu" class="nav nav-list collapse in">
            <li class="active" ><a href="<?php echo SITE_URL.'admin/add/news'; ?>">Add News</a></li>
...
<?php
	echo "<div class='containerdiv'>";
		echo "<br clear='all' />";
		echo $this->Form->Create('News',array('url'=>array('controller'=>'/','action'=>'/admin/add/news'),'id'=>'newsform'));
			
			echo "<div id='forms'>";
				echo $this->Form->input('title',array('type'=>'text','label'=>'News Title','id'=>'title','class'=>'inputform'));
				
				echo "<span>Maximum 100 words allowed for summary</span>";
				echo '<br/>';
				echo 'News Summary:';echo '<br/>';
				echo '<textarea rows="2" cols="20" name="data[News][summary]" id="summary" class = "textareas" maxlength="100"></textarea>';
				echo '<br/>';
				echo 'News Description:';echo '<br/>';
				echo '<textarea rows="2" cols="20" name="data[News][content]" id="description" class = "textareas"></textarea>';
				
				
				
				//echo $this->Form->input('summary',array('type'=>'textarea','label'=>'News Summary','id'=>'summary','class'=>'textareas','maxlength'=>'100'));
				
				//echo $this->Form->input('content',array('type'=>'textarea','label'=>'News Description','id'=>'description','class'=>'textareas'));
				
				echo $this->Form->input('status',array('type'=>'radio','options'=>array('publish'=>'Publish','unpublish'=>'Unpublish'),'label'=>'Status','id'=>'status','class'=>'inputform status','default'=>'unpublish'));
