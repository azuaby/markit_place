...
<div class="content">
      ...
      <li><a href="<?php echo SITE_URL;?>admin/user/management/" >Approved Users</a></li>
      <li class="active"><a href="#" >Pending User Approval</a></li>      
						</ul>     					
  ...
  <label>Search:
  <?php 
  echo "<input type='text' style='background:#ffffff;border:1px solid;color:#555555! important;margin-top:7px;' name='searchfield' id='nonusersrchSrch' onkeyup='search_user_func();'>";
  ?>
  </label>
