...
<button class="btn btn-primary" onclick="paid_order_search()" style="vertical-align:inherit;">Search</button>';
							...
							{								
								foreach($getitemuser as $key=>$user_det){
									...
									echo '<tr id="del_'.$id.'">';
										...
										echo '<td>
									<a class="viewitem" href="'.SITE_URL.'viewPaid/'.$id.'" ><span class="btn btn-success"><i class="icon-zoom-in"></i></span></a></td>';
										//echo '<td>';
										?>
