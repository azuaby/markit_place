...
<div class="content">
    ...
    <li class="active">Manage Seller</li>
      ...
      <li><a href="<?php echo SITE_URL; ?>admin/manage/sellers" >Approved Sellers</a></li>
      <li class="active"><a href="#" >Pending Aeller Approval</a></li>      
						</ul>  					
	...
	<input type="button" id="srchnonapproveSeller" name="submit" value="Search" class="btn btn-primary" style="margin: 0px 10px 10px; border-radius: inherit;vertical-align:inherit;" />
