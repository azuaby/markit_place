<?php ?>	<body class=""> 
 ...
 <div class="content">
            ...
            <li><a href="<?php echo SITE_URL; ?>">Home</a> <span class="divider">/</span></li>
           	<li><a href="<?php echo SITE_URL.'admin/merchant_payment/'; ?>">New Orders</a> <span class="divider">/</span></li>
...
<?php
	...
	echo '<div class="inv-tot" style="margin-top:12px;margin-left:850px;">';
