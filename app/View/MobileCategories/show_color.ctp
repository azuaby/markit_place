	...
	<div class="container shop">
		<div class="wrapper-content">
			...
			<div class="ui-body ui-body-a">
				<h3 class="showprihead">By <?php echo $color; ?></h3>
				</div>
				<div id="list-thumbnails-13852199">
				<span id="deal-listing">
				<?php 
				...
				echo  "<a href='".SITE_URL."people/".$username_url_ori."' class='userv vcard' style='text-decoration:none;'>
						...
						echo "<br /><i class='arrow-sml' style='color: rgb(138, 143, 156); margin-top: 24px;display:none;'>$username</i>
						</a>";
						...
						echo '<span class="figure" style="background: url(\''.$img.'\'); background-repeat: no-repeat;background-position: 50% 50%;background-size: cover; float: left; width: 207px; height: auto:overflow:hidden;"></span><br />';
						echo  "<center><img src='".$_SESSION['media_url']."media/items/thumb350/".$image_name."'  id='img_id".$itms['Item']['id']."'></center>";
						echo "</figure>";
						echo  '</a>';
...
$(window).scroll(function () {
	 //if ($(document).height() - 50 <= $(window).scrollTop() + $(window).height()) {
	  ...
	  if (isPreviousEventComplete && isDataAvailable) {
		...
		var baseurl = getBaseURL()+"mobilecategories/getmorepricecolor";
