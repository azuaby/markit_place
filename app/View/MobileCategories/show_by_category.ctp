...
<div class="ui-body ui-body-a">
			<table width="100%"><thead><tr><th></th><th></th></tr></thead><tbody><tr><td>
			 ...
			 if ($categoryData != null) { ?>		
                <span class='last'>/ <a data-ajax="false" style="text-decoration:none;font-size:15px;color:#373D48;" href="<?php echo SITE_URL."mobile/shop/".$categoryData['Category']['category_urlname']; ?>"><?php echo $categoryData['Category']['category_name']; ?></a></span>
		<?php 
			
			$categoryName = $categoryData['Category']['category_urlname'];
			$currentUrl = "shop/".$categoryName;
			if ($subCatName != null) { ?>
				<span class='last'>/ <a href="<?php echo SITE_URL."mobile/shop/".$categoryName."/".$subCatName; ?>"><?php echo ucwords($subCatName); ?></a></span>
		<?php	$currentUrl = $currentUrl."/".$subCatName;
				} }?>
				</td><td align='right'>
    <div align="right"><a href="#myPopup" data-rel="popup" data-position-to="window" class="ui-btn ui-btn-inline ui-corner-all" style="height:10px;margin:0px -5px 5px 0px;"><span style="position:relative;top:-5px;">Filterlist</span></a></div>
    </td></tr></tbody></table>
   ...
   <div >
		...
		<div id="content" style="margin-top:-20px;">
				...
				<div class="search-frm">
					<div class="search">
					<div data-role="popup" id="myPopup" class="ui-content" data-dismissible="true">
					...
					?>
						...
						<div class = "styled selectdiv">
						Color :
						<select id="color-filter" class="shop-select color-filter palette selectboxdiv">
                        	...
                        	<div class="out" style="display:none;"><?php echo __('Any Color');?></div>
						</div>
						<div class = "styled selectdiv">
						Newest : 
                        <select id="sort-by-price" class="shop-select sort-by-price selectboxdiv">
                            <option value="">Newest</option>
                            <option value="asc">Price: Low to High</option>
                            <option value="desc">Price: High to Low</option>
                        </select>
                        	<div class="out" style="display:none;"><?php echo __('Newest');?></div>
						</div>
    ...
    <img id="im'.$itms['Item']['id'].'" src="'.SITE_URL.'images/logo/fantacy.png" style="margin: -1px;margin-left:-8px;"></span>
     ...
     <input type="hidden" value="'.$setngs[0]['Sitesetting']['like_btn_cmnt'].'">
			...
			{
				echo '<div class="ui-body ui-body-a" style="text-align:center;">No Items found</div>';
			}
		?>
