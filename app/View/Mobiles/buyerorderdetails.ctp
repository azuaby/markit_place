...
<?php 
if($orderModel['Orders']['status']=="Shipped")
{
echo '<button type="button" onclick="markprocess(\''.$orderModel['Orders']['orderid'].'\',\'Delivered\')" style="background:#4A84BE;color:#ffffff;text-shadow:none;">Mark as received</button>';
echo '<img class="buyerst-loader-'.$orderid.'" src="'.SITE_URL.'images/loading.gif" style="display: none; float: right; width: 12px; padding-top: 6px;">';
