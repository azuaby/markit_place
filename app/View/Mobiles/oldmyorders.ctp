<div class="container set_area" style="width:940px;">
        ...
        <div class="markshiphead" style="font-size:14px; margin-bottom: 14px;">
        	My Sales
        	<span class="myordertimeline"> (Sales History)</span>
        	<div class="viewoldorder"><a data-ajax="false" href="<?php echo SITE_URL;?>mobile/orders" title="view recent orders">View recent orders</a></div>
        </div>
