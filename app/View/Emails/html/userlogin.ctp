					...
					<td width="100%" valign="top" align="left" bgcolor="#ffffff"style="font-family: Georgia, serif; background: #fff;">
						...
						<tr>
							<td style="padding: 18px 0 0;" align="left">			
								<h2 style=" font-weight: normal; margin: 0; padding: 0 0 12px; font-style: inherit; line-height: 30px; font-size: 25px; font-family: Trebuchet MS; border-bottom: 1px solid #333333; "> Hello <?php echo $name; ?>, Welcome to <?php echo SITE_NAME; ?></h2>
							</td>
						</tr>
							...
							<tr>
								<td style="padding: 15px 0;"  valign="top">
									<p style='margin-bottom: 10px'>
										Greetings! Thanks for registering with <?php echo SITE_NAME; ?>.
									</p>
									<p style='margin-bottom: 10px'>
										To complete the registration of your new account, 
									...
									<p style='margin-bottom: 10px'>
										If clicking this link does not work, copy and paste the link directly into 
										the address bar of your browser. If you are still having problem, simply 
										contact our support team by writing to <?php echo $setngs[0]['Sitesetting']['support_email']; ?>
									</p>
									<p style='margin-bottom: 10px'>
										Once you do, you will be able to access to the notification of activity and 
										access of other features that requires a valid email address.
									</p>
