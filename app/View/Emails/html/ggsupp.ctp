							...
							<tr>
								<td style="padding: 15px 0 45px;"  valign="top">
									<p style="color:#767676; font-weight: normal; margin: 0; padding: 0; line-height: 20px; font-size: 12px;font-family: Georgia, serif; ">
											There is an order placed on you shop at <?php echo $setngs[0]['Sitesetting']['site_name']; ?>
									</p>
									<br>
									<p style="color:#767676; font-weight: normal; margin: 0; padding: 0; line-height: 20px; font-size: 12px;font-family: Georgia, serif; ">
											Item Details:
									...
									<p style="color:#767676; font-weight: normal; margin: 0; padding: 0; line-height: 20px; font-size: 12px;font-family: Georgia, serif; ">
										...
										<br clear="all" /><br />
											...
											Country:-  <?php echo $countryName; ?><br />
									...
									<!-- <p style="color:#767676; font-weight: normal; margin: 0; padding: 0; line-height: 20px; font-size: 12px;font-family: Georgia, serif; ">
										<a href="<?php echo $access_url; ?>">Please click the link after ship the items</a>
									</p> -->
