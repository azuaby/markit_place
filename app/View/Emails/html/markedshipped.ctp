					...
					<td width="100%" valign="top" align="left" bgcolor="#ffffff"style="font-family: Georgia, serif; background: #fff;">
						...
						<tr>
							<td style="padding: 18px 0 0;" align="left">			
								<h2 style=" font-weight: normal; margin: 0; padding: 0 0 12px; font-style: inherit; line-height: 30px; font-size: 25px; font-family: Trebuchet MS; border-bottom: 1px solid #333333; ">Your order has been dispatched from the seller - Order ID is #<?php echo $orderId; ?>.</h2>
							</td>
						</tr>
							...
							<tr>
								<td style="padding: 15px 0;"  valign="top">
									...
									<p style='margin-bottom: 10px'>
										The seller confirmed the shipment of your order #<?php echo $orderId; ?>. 
										Shortly you will be notified with the 
										tracking details of your order shipment. 
									</p>
									<p style='margin-bottom: 10px'>
