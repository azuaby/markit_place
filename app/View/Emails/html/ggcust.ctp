					...
					<td width="620" valign="top" align="left" bgcolor="#ffffff"style="font-family: Georgia, serif; background: #fff;">
						...
						<tr>
							<td style="padding: 25px 0 0;" align="left">			
								<h2 style="color:#8598a3; font-weight: normal; margin: 0; padding: 0; font-style: italic; line-height: 30px; font-size: 30px;font-family: Georgia, serif; "> Hi <?php echo $custom; ?>,</h2>
							</td>
						</tr>
							...
							<tr>
								<td style="padding: 15px 0 45px;"  valign="top">
									<p style="color:#767676; font-weight: normal; margin: 0; padding: 0; line-height: 20px; font-size: 12px;font-family: Georgia, serif; ">
											You have Created the item for Group gift . Soon your friend  will get the Item from <?php echo $setngs[0]['Sitesetting']['site_name']; ?>
									</p>
									<br>
									<p style="color:#767676; font-weight: normal; margin: 0; padding: 0; line-height: 20px; font-size: 12px;font-family: Georgia, serif; ">
											Item Details:
									...
									<!-- <p style="color:#767676; font-weight: normal; margin: 0; padding: 0; line-height: 20px; font-size: 12px;font-family: Georgia, serif; ">
										Please <a href="<?php echo $access_url; ?>"> click </a> the link after recevie the items,If you do not receive the item <a href="<?php echo $access_url_n_d; ?>">Click here</a>
									</p> -->
