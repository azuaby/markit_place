					...
					<td width="100%" valign="top" align="left" bgcolor="#ffffff"style="font-family: Georgia, serif; background: #fff;">
						...
						<tr>
							<td style="padding: 18px 0 0;" align="left">			
								<h2 style=" font-weight: normal; margin: 0; padding: 0 0 12px; font-style: inherit; line-height: 30px; font-size: 25px; font-family: Trebuchet MS; border-bottom: 1px solid #333333; "> Your order confirmation - The order ID(s) <?php echo $orderId; ?>.</h2>
							</td>
						</tr>
							...
							<tr>
								<td style="padding: 15px 0;"  valign="top">
									...
									<p style='margin-bottom: 10px'>
										Thank you for shopping on <?php echo $setngs[0]['Sitesetting']['site_name']; ?>! Kindly note down the order ID(s) 
										<?php echo $orderId; ?> as a reference number for this purchase.
									</p>
									<p style='margin-bottom: 10px'>
										Your order is confirmed. The same has been notified to the seller 
										too. Once the order is shipped by the seller, we will send you an 
										email with the shipment details from the seller. In case if you have 
										ordered multiple items from multiple sellers, all your orders may be 
										delivered separately. All your orders can be seen and tracked through 
										your <?php echo $setngs[0]['Sitesetting']['site_name']; ?> account also.
									</p>
									<p style='margin-bottom: 10px'>
										Your order details:
									</p>
									<p style='margin-bottom: 10px'>
										Order ID(s): <?php echo $orderId; ?>
										<br>
									...
									<p style='margin-bottom: 10px'>
										Your order is safe and been monitored closely with the seller when 
										you shop on <?php echo $setngs[0]['Sitesetting']['site_name']; ?>. In case if you don’t 
										receive your order from the seller(s) or it is delivered in an unsatisfactory condition, 
										you can reach us through <?php echo $setngs[0]['Sitesetting']['support_email']; ?>. When you 
										write to us about any orders, please mention the order ID to get quick response 
									...
									<p style='margin-bottom: 10px'>
										...
										us in case of any problem in the orders.
									</p>
									<p style='margin-bottom: 10px'>
