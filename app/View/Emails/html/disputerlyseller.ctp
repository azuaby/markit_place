						...
						<tr>
							<td style="padding: 18px 0 0;" align="left">			
								<h2 style=" font-weight: normal; margin: 0; padding: 0 0 12px; font-style: inherit; line-height: 30px; font-size: 25px; font-family: Trebuchet MS; border-bottom: 1px solid #333333; ">
									Buyer has responded to the dispute - Dispute ID is #<?php echo $liid;?>.
								</h2>
							</td>
						</tr>
							...
							<tr>
								<td style="padding: 15px 0;"  valign="top">
									<p style='margin-bottom: 10px'>
										Hello <?php echo $sellerName; ?>,
									</p>
									<p style='margin-bottom: 10px'>
										<?php echo '<a href="'.SITE_URL.'disputeBuyer/'.$gor.'">'
										.$buyerfirstname.'</a>'; ?> has replied to the dispute raised on the 
										order #<?php echo $gor;?>. Kindly check the response and get back 
										to the buyer as soon as possible to take necessary actions.
									</p>
									<p style='margin-bottom: 10px'>
										Dispute ID: #<?php echo $liid;?>
									</p>
									<p style='margin-bottom: 10px;'>
										Message from buyer:</p>
									...
									<p style='margin-bottom: 10px;color:red;'>
										NOTE: If you fail to respond on any latest reply on any disputes 
										in a certain time, there is a possibility of closing the dispute 
										and resulting the dispute in favor of the other party. So, we 
										recommend to act immediately on disputes.
									</p>
									<p style='margin-bottom: 10px;'>
