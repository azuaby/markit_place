					...
					<td width="100%" valign="top" align="left" bgcolor="#ffffff"style="font-family: Georgia, serif; background: #fff;">
						...
						<tr>
							<td style="padding: 18px 0 0;" align="left">			
								<h2 style=" font-weight: normal; margin: 0; padding: 0 0 12px; font-style: inherit; line-height: 30px; font-size: 25px; font-family: Trebuchet MS; border-bottom: 1px solid #333333; "> Hello <?php echo $name; ?>, 
Your new password generated successfully.</h2>
							</td>
						</tr>
							...
							<tr>
								<td style="padding: 15px 0;"  valign="top">
									...
									<p style='margin-bottom: 10px'>
										...
										The new password is provided along with this email. 
										If you did not initiate this request, 
										kindly ignore this email and change your password manually for 
										security purpose.
									</p>
									<p style='margin-bottom: 10px'>
										Here is your new password: <?php echo $uniquecode_pass; ?>
									</p>
									<p style='margin-bottom: 10px'>
										If you still have any problem in accessing your account, 
										we would like you to write your problems to 
