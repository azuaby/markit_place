					...
					<td width="100%" valign="top" align="left" bgcolor="#ffffff"style="font-family: Georgia, serif; background: #fff;">
						...
						<tr>
							<td style="padding: 18px 0 0;" align="left">			
								<h2 style=" font-weight: normal; margin: 0; padding: 0 0 12px; font-style: inherit; line-height: 30px; font-size: 25px; font-family: Trebuchet MS; border-bottom: 1px solid #333333; "> Item Approval Request From <?php echo $username; ?></h2>
							</td>
						</tr>
							...
							<tr>
								<td style="padding: 15px 0;"  valign="top">
									<p style='margin-bottom: 10px'>
										Hello <?php echo SITE_NAME; ?> Admin,
									</p>
									<p style='margin-bottom: 10px'>
			There is a new item added by the user <?php echo $username; ?>


									</p>
									<p style='margin-bottom: 10px'>
			Product Details<br />
			Product name : <?php echo $itemname; ?><br />
			Quantity : <?php echo $quantity; ?><br />
			Price : <?php print_r($itemprice); ?><br />
			Sizes : <?php echo $sizeoptions; ?><br />
									</p>
