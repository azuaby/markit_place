					...
					<td width="620" valign="top" align="left" bgcolor="#ffffff"style="font-family: Georgia, serif; background: #fff;">
						...
						<tr>
							<td style="padding: 25px 0 0;" align="left">			
								<h2 style="color:#8598a3; font-weight: normal; margin: 0; padding: 0; font-style: italic; line-height: 30px; font-size: 30px;font-family: Georgia, serif; "> Hi, <?php echo $item_user_name; ?></h2>
							</td>
						</tr>
							...
							<tr>
								<td style="padding: 15px 0 45px;"  valign="top">
									<p style="color:#767676; font-weight: normal; margin: 0; padding: 0; line-height: 20px; font-size: 12px;font-family: Georgia, serif; ">
										<?php 
										$usrimg = $loguser[0]['User']['profile_image'];
										if(!empty($usrimg)){
									...
									<br>
									<p style="color:#767676; font-weight: normal; margin: 0; padding: 0; line-height: 20px; font-size: 12px;font-family: Georgia, serif; ">
										 <?php echo $name; ?> is featured your item on <b> <?php echo ucwords(strtolower($setngs[0]['Sitesetting']['site_name'])); ?></b><br />
									</p>
								</td>
							</tr>			
