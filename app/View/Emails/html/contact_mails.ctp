 ...
 <?php echo $this->element('emailHeader'); ?>  
					...
					<td width="100%" valign="top" align="left" bgcolor="#ffffff"style="font-family: Georgia, serif; background: #fff;">
						...
						<tr>
							<td style="padding: 18px 0 0;" align="left">			
								<h2 style=" font-weight: normal; margin: 0; padding: 0 0 12px; font-style: inherit; line-height: 30px; font-size: 25px; font-family: Trebuchet MS; border-bottom: 1px solid #333333; "> Query From <?php echo $name; ?></h2>
							</td>
						</tr>
		<tr>
		...
		<tr>
			<td style="padding: 15px 0;"  valign="top"> 
			User Email : <?php echo $email; ?> </td>
		</tr>		
		<tr>
			<td style="padding: 15px 0;"  valign="top"> 
			Topic : <?php echo $topic; ?> </td>
		</tr>
		<?php if ($order != '') { ?>
		<tr>
			<td style="padding: 15px 0;"  valign="top"> 
			Order No. <?php echo $order; ?> </td>
		</tr>
		<?php } ?>
		<?php if ($userAccount != '') { ?>
		<tr>
			<td style="padding: 15px 0;"  valign="top"> 
			User Account : <?php echo $userAccount; ?> </td>
		</tr>
		<?php } ?>
		<tr>
			<td style="padding: 15px 0;"  valign="top">
