							...
							<tr>
								<td style="padding: 15px 0 45px;"  valign="top">
									<p style="color:#767676; font-weight: normal; margin: 0; padding: 0; line-height: 20px; font-size: 12px;font-family: Georgia, serif; ">
										<?php echo $sellername;?>	Send  on User Fashion Image
									</p>
									<br>
									<?php //echo "<img src='".$_SESSION['media_url']."media/items/thumb150/".$imgupfa."' alt='".$imgupfa."' width='148px' height='100px' />"; ?>
									<p style="color:#767676; font-weight: normal; margin: 0; padding: 0; line-height: 20px; font-size: 12px;font-family: Georgia, serif; ">
									<?php if ($status == 'Yes') {?>		
											 <b>your fashion was approved in the store by the seller.</b>
									<?php }else{?>
									 <b>your fashion was not approved in the store by the seller.</b>
									<?php } ?>
									</p>
								</td>
							</tr>			
