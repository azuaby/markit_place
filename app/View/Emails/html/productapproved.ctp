					...
					<td width="100%" valign="top" align="left" bgcolor="#ffffff"style="font-family: Georgia, serif; background: #fff;">
						...
						<tr>
							<td style="padding: 18px 0 0;" align="left">			
								<h2 style=" font-weight: normal; margin: 0; padding: 0 0 12px; font-style: inherit; line-height: 30px; font-size: 25px; font-family: Trebuchet MS; border-bottom: 1px solid #333333; "> Product is approved and ready for sale - Product ID #<?php echo $itemId; ?></h2>
							</td>
						</tr>
							...
							<tr>
								<td style="padding: 15px 0;"  valign="top">
									...
									<p style='margin-bottom: 10px'>
			We have reviewed your product details and we have approved your product for sale on <?php echo SITE_NAME; ?>. In case of any changes, we will have to approve the changes again. 


									</p>
									<p style='margin-bottom: 10px'>
You can also edit the products under your profile, by access "Added" tab. 
									</p>
									<p style='margin-bottom: 10px'>
			Product link: <?php echo '<a href="'.SITE_URL.'listing/'.$itemId.'/'.$item_url.'">'.$item_title.'</a>'; ?>
