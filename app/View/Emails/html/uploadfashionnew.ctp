						...
						<tr>
							<td style="padding: 18px 0 0;" align="left">			
								<h2 style=" font-weight: normal; margin: 0; padding: 0 0 12px; font-style: inherit; line-height: 30px; font-size: 25px; font-family: Trebuchet MS; border-bottom: 1px solid #333333; ">
									<?php echo $sellername; ?> uploaded a fashion on your product, it is waiting for your approval.
								</h2>
							</td>
						</tr>
							...
							<tr>
								<td style="padding: 15px 0;"  valign="top">
									<p style='margin-bottom: 10px'>
										Hello <?php echo $buyername; ?>,
									</p>
									<p style='margin-bottom: 10px'>
										There is a user uploaded his fashion photo on the following product link. To make it public you need to review the pictures and please approve the same.
									
									</p>
									<p style='margin-bottom: 10px'>
									To approve this fashion upload, please login into your fantacy account and go to your profile page and click “User Fashion” tab and click “Show” button.
									
									</p>
									<p style='margin-bottom: 10px'>
										Link for your fashion upload: <?php echo "<a href='".SITE_URL."people/".$buyerurl."?userapprove'>"; ?><?php echo ucwords(strtolower($buyername)); ?></a>
									</p>
