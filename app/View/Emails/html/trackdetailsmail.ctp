					...
					<td width="100%" valign="top" align="left" bgcolor="#ffffff"style="font-family: Georgia, serif; background: #fff;">
						...
						<tr>
							<td style="padding: 18px 0 0;" align="left">			
								<h2 style=" font-weight: normal; margin: 0; padding: 0 0 12px; font-style: inherit; line-height: 30px; font-size: 25px; font-family: Trebuchet MS; border-bottom: 1px solid #333333; ">Shipment tracking details - Order ID is #<?php echo $orderId; ?>.</h2>
							</td>
						</tr>
							...
							<tr>
								<td style="padding: 15px 0;"  valign="top">
									...
									<p style='margin-bottom: 10px'>
										Shipment tracking details are: <br><br>
										<?php echo "Shipment Started On: ".$shippingdate; ?><br>
										<?php echo "Logistic Name: ".$couriername." &nbsp;&nbsp;&nbsp;&nbsp;Service Type: ".$courierservice; ?><br>
										<?php echo "Tracking Id: ".$trackingid; ?><br>
										<?php echo "Additional Notes: ".$notes; ?><br>
									</p>
									<p style='margin-bottom: 10px'>
										Your order details:
									</p>
