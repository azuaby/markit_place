					...
					<td width="100%" valign="top" align="left" bgcolor="#ffffff"style="font-family: Georgia, serif; background: #fff;">
						...
						<tr>
							<td style="padding: 18px 0 0;" align="left">			
								<h2 style=" font-weight: normal; margin: 0; padding: 0 0 12px; font-style: inherit; line-height: 30px; font-size: 25px; font-family: Trebuchet MS; border-bottom: 1px solid #333333; "> Hi there, your friend <?php echo $loguser[0]['User']['first_name']; ?> inviting you.</h2>
							</td>
						</tr>
							...
							<tr>
								<td style="padding: 15px 0;"  valign="top">
									...
									<p style='margin-bottom: 10px'>
										Greetings from <?php echo SITE_NAME;?>!
									</p>
									<p style='margin-bottom: 10px'>
										You have received an invitation from 
										<?php echo $loguser[0]['User']['first_name']; ?> to join 
										<?php echo SITE_NAME; ?>. Please click the link below to accept 
										the invitation and to create your new account with 
										<?php echo $setngs[0]['Sitesetting']['site_name']; ?>.
									</p>
									<p style='margin-bottom: 10px'>
										Invitation link: <?php echo "<a href='".SITE_URL."signup?referrer=".$loguser[0]['User']['username']."'>Join with me</a>"; ?>
									</p>
									<p style='margin-bottom: 10px'>
										To view <?php echo $loguser[0]['User']['first_name']; ?>'s  profile, please click the link below.
									</p>
									<p style='margin-bottom: 10px'>
										Link:  <?php echo "<a href='".SITE_URL."people/".$loguser[0]['User']['username']."'>"; ?><?php echo ucwords(strtolower($loguser[0]['User']['username'])); ?></a>
									</p>
									<?php if ($msg != ""){ ?>
										<p style='margin-bottom: 10px'>
									...
									<?php } ?>
									<p style='margin-bottom: 10px'>
										Joining to <?php echo $setngs[0]['Sitesetting']['site_name']; ?> & referring your friends is not only sharing the fun, but you will get some additional benefits too. Go to our help section to read more about the referral program. 
									</p>
