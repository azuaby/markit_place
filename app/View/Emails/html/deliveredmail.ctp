					...
					<td width="100%" valign="top" align="left" bgcolor="#ffffff"style="font-family: Georgia, serif; background: #fff;">
						...
						<tr>
							<td style="padding: 18px 0 0;" align="left">			
								<h2 style=" font-weight: normal; margin: 0; padding: 0 0 12px; font-style: inherit; line-height: 30px; font-size: 25px; font-family: Trebuchet MS; border-bottom: 1px solid #333333; ">The shipment was successfully delivered to buyer - Order ID #<?php echo $orderid; ?>.</h2>
							</td>
						</tr>
							...
							<tr>
								<td style="padding: 15px 0;"  valign="top">
									...
									<p style='margin-bottom: 10px'>
										If you do not receive your fund within the time, kindly send an email to the <?php echo $setngs[0]['Sitesetting']['support_email']; ?>. 
									...
									<p style='margin-bottom: 10px'>
										Buyer: <?php echo "<a href='".SITE_URL."people/".$loguser[0]['User']['username']."'>"; ?><?php echo ucwords(strtolower($buyername)); ?></a>
										<br>
									...
									<p style='margin-bottom: 10px'>
										Ship to:
										<br clear="all" /><br />
										Name:-  <?php echo $usershipping_addr['Shippingaddresses']['name']; ?><br />
										Address1:-  <?php echo $usershipping_addr['Shippingaddresses']['address1']; ?><br />
										Address2:-  <?php echo $usershipping_addr['Shippingaddresses']['address2']; ?><br />
										City:-  <?php echo $usershipping_addr['Shippingaddresses']['city']; ?><br />
										State:-  <?php echo $usershipping_addr['Shippingaddresses']['state']; ?><br />
										Country:-  <?php echo $usershipping_addr['Shippingaddresses']['country']; ?><br />
										Zip code:-  <?php echo $usershipping_addr['Shippingaddresses']['zipcode']; ?><br />
										Phone:-  <?php echo $usershipping_addr['Shippingaddresses']['phone']; ?><br />
									</p>
