						...
						<tr>
							<td style="padding: 18px 0 0;" align="left">			
								<h2 style=" font-weight: normal; margin: 0; padding: 0 0 12px; font-style: inherit; line-height: 30px; font-size: 25px; font-family: Trebuchet MS; border-bottom: 1px solid #333333; ">
									Your dispute has been resolved successfully - Dispute ID is #<?php echo $disid;?>.
								</h2>
							</td>
						</tr>
							...
							<tr>
								<td style="padding: 15px 0;"  valign="top">
									...
									<p style='margin-bottom: 10px'>
										Your dispute #<?php echo $disid;?> has been resolved successfully.
									</p>
									<p style='margin-bottom: 10px'>
										In case if you have need any further assistance on this dispute, please write to our support team email <?php echo $setngs[0]['Sitesetting']['support_email']; ?>
