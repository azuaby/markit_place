...
<script type="text/javascript"  > 
    ...
    foreach($cat_datas as $cats){
        echo $cats['Category']['id']."  : '".$cats['Category']['category_del_type']."',";
    }
    ?>
    }
</script>
...
@$hostname = $_SESSION['media_host_name'];
	...
	<?php //echo "<div class='form-head'><p>List an Item</p></div>"; ?>
                <div class="section-inner clear">                                
					<section class="merchant" style="width:950px;margin: 0 auto;">
						...
						<dt>Category</dt>
							...
							echo $this->Form->input('category_id',array('type'=>'select','options'=>$catarr, 'label'=>'', 'id'=>'cate_id', 'class'=>'inputform selectboxdiv', 'empty'=>'Select a Category', 'div' => false,'onchange'=>'set_deltypes()'));			
							echo '<div class="out" >Select a Category</div>';
							echo "</div>";
							?>
							...
							<div id='categ-container-2' class='select-group inactive selectdiv' style='margin-right: 10px;display:none;'>
								...
								</select>	<div class="out" >Select a Category</div>
							</div>
			...
			<dl>
				...
				<dd>
					<label for=""  class="label"><?php echo __('Item Color');  ?></label>
					<select id="detectmethod" onchange="detect_method()" name="data[colormethod]">
						<option value="">Select</option>
						<option value="auto">Auto Detection</option>
						<option value="manual">Choose Manually</option>
					</select> 		
				</dd>
				<dd id="manual_select" style="display:none;">
					<label for=""  class="label"><?php echo __('Select Color');  ?></label>					
					<select id="item_color_manual" name="itemcolor[]" multiple="multiple" style="height: 90px;margin-bottom: 10px;" >
						<?php
			...
			<dl>
				...
				<dd>
					<label for=""  class="label"><?php echo __('Which gender the item for ?');  ?></label>				
						...
						<div class="out" >Select gender</div>
						</div>			
				</dd>
				...
				<dd>
					<label for=""  class="label"><?php echo __('Shipping'); ?></label>
						...
						<div class="out" ><?php echo __('Ready to ship in...'); ?></div>
						</div>			
				</dd>
				<dd>
			...
			<dl>
				...
				<dd>
					...
					<div class="selectdiv" style="float: left; width: 172px;">
						...
						<div class="out" ><?php echo __('Select a location...'); ?></div>
						</div>
				...
				<dd>
					...
					<div  style="float: left; width: 172px;">
                        <select name="deltype"  id="deltype" disabled="disabled">			
					...
					<!-- <label for=""  class="label"><?php echo __('Ships to'); ?>:</label> -->
					  ...
					  <div style="" class="set-shipping-rates">
					        <table class="shipping-rates msm" id="shpng_div">
							   <thead>
					              <tr>
					             <th class="ship-to" style="font-size:15px;"><dd><?php echo __('Ships to'); ?></dd></th>
					                  <th style="font-size:15px;"><dd>Cost</dd></th>
					                  <th colspan="2" style="font-size:15px;"><dd>Remove</dd></th>
					              </tr>
					           </thead>
					           <tbody> 
									<tr class="new-shipping-location <?php echo $cntryid[$cntry_code]; ?>">       
										<td id="<?php echo $cntryid[$cntry_code]; ?>" style="width: 250px;">        
									...
									<tr class="new-shipping-location E">       
										...
										<td class="input-group-close" style="width: 250px;">       
											<div class="input-group input-group-price price-input primary-shipping-price">
