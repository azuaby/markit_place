<body class=""> 
 ...
 <div class="content">
    ...
    <li><a href="<?php echo SITE_URL; ?>">Home</a> <span class="divider">/</span></li>
      ...
      <li><a href="<?php echo SITE_URL;?>admin/manage/items" >Approved Items</a></li>
      <li class="active"><a href="#" >Pending Item Approval</a></li>      
						</ul>  
...
<input type="button" id="srchnonItms" name="submit" value="Search" class="btn btn-primary" style="margin: 0px 10px 10px; border-radius: inherit;" />
...
<?php	
		...
		//echo "<div class='addctdivs'>";
			//echo $this->Html->link('Add Category',array('controller'=>'/','action'=>'/admin/manage/nonapproved_items/'),array('class'=>'btn btn-success'));
		//echo "</div>";
