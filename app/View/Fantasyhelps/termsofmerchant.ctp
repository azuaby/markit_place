	...
	<div class="snb">
		<div style="display:block" class="inner help">
			...
			<ul>
				...
				<li><a class="current" href="<?php echo SITE_URL; ?>help/terms_merchant"><?php echo __('Terms and Conditions of Merchant Sale'); ?></a></li>
...
<div class="wrapper help">
	<div class="container faq">
		<h2 class="ptit">
			<?php echo __('Help');?> /
			<b><?php echo __('Terms and Conditions of Merchant Sale'); ?></b>
		</h2>
		<div id="content" style="min-height: 89px;">
			<div class="intro">
				<h3><?php echo __('Terms and Conditions of Merchant Sale'); ?></h3>
				<p>
			...
			<div class="faq-chept">
				<div >
					...
					<?php echo __('Terms and Conditions of Merchant Sale'); ?>
