	...
	<div class="snb">
		<div style="display:block" class="inner help">
			...
			<ul>
				...
				<li><a class="current" href="<?php echo SITE_URL; ?>help/privacy"><?php echo __('Privacy'); ?></a></li>
			</ul>
		</div>
	</div>
</div>
<div class="wrapper help">
	<div class="container faq">
		<h2 class="ptit">
			<?php echo __('Help');?> /
			<b><?php echo __('Privacy'); ?></b>
		</h2>
		<div id="content" style="min-height: 89px;">
			<div class="intro">
				<h3><?php echo __('Privacy'); ?></h3>
				<p>
					...
					<?php echo UrlfriendlyComponent::limit_text($main,10000); ?>
				</p>
			</div>
			<div class="faq-chept">
				<div >
