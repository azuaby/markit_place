						...
						<div class="gifts-summary">
							...
							<div class="respcreat">
								<div class="ggresp">
									...
									<?php $lday=date("F j, Y ",$items_list_data['Groupgiftuserdetail']['cdate']); ?>
							...
							<div class="contrilist">
								...
								<div class="contrilistcont">
									...
									<span class="date"><?php echo $lday; ?></span>
									<div class="contripaidamt">$<?php echo $ggdata['Groupgiftpayamt']['amount']; ?></div>
									</div>
								</div>
								<?php 
...
<!-- / content -->
			...
			<div class=" figure-row first sepProduView recipient">
				...
				<?php } ?>
					...
					<b class="username"><?php echo $items_list_data['Groupgiftuserdetail']['name']; ?></b>
					<?php $recepientday=date("F j, Y ",$items_list_data['Groupgiftuserdetail']['cdate']); ?>
				...
				<div class="notify">
					This group gift will be delivered after the successful contribution from everyone.
				</div>
				
			</div>
			<div class="figure-row first sepProduView contributions">
				<h1 class="stiteg">Contributions</h1>
				<div class="prize">
					<?php if($paidamt == ''){
						$paidamt = '0.00';
					}else{
					...
					<?php 
						...
						?>
					<?php echo $_SESSION['default_currency_symbol'].$paidamt; ?>/<?php echo $_SESSION['default_currency_symbol'].($items_list_data['Groupgiftuserdetail']['itemcost'] + $items_list_data['Groupgiftuserdetail']['shipcost']) ; ?>
				...
				<div class="contristatus">
					<div class="contristatusdiv">
						Status: <span style="<?php echo $color; ?>"><?php echo $items_list_data['Groupgiftuserdetail']['status']; ?></span>
					</div>
					<div class="totcontri">
						Total contributors: <?php echo count($paidUserId);?> people
					</div>
				</div>
				...
				<div class="contripayment">					
					...
					<button class="contribubtn-green" <?php echo $disabled; ?> onclick="contributeChkOut(<?php echo $ggid; ?>)">Contribute</button>
					
				</div>
				<?php } ?>
				<div class="notify">
						This group gift must receive all contributions by <?php $finaldate = $items_list_data['Groupgiftuserdetail']['c_date'] + 604800;echo $lday=date("F j, Y ",$finaldate); ?> to be successful.
						</br>Unsuccessful gift will be refunded.
				</div>
			</div>
			
			<div class="figure-row first sepProduView product-info">
				<h1 class="stiteg">Product Info</h1>
				...
				Markit'd by <?php echo $item_datas['Item']['fav_count'];?> people</div>
