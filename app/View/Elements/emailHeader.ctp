...
<table cellpadding="0" cellspacing="0" border="0" align="center" width="100%" style="font-family: Georgia, serif;" class="header">
      <tr>
        <td bgcolor="#FFFFFF" height="60" align="left">
			...
			<a rel="nofollow" target="_blank" href="<?php echo SITE_URL; ?>">
				<?php 
				if(!empty($setngs[0]['Sitesetting']['site_logo'])){
					echo '<img src="'.SITE_URL.'images/logo/'.$setngs[0]['Sitesetting']['site_logo'].'" style="width: 130px;">';
				}else{
					echo '<img src="'.SITE_URL.'images/logo.png" style="width: 130px;">';
				}
				?>
			</a>
			...
			<!-- <p style="color: #dfa575; font: normal 11px Georgia, serif; margin: 0; padding: 0; line-height: 11px;">Markit Social eCommerce</p> -->
        </td>
      </tr>
	  <tr>
		<td style="width: 100%;height: 2px;">
    		<div style="width: 50%;background-color: #3394f6;max-height: 3px;float: left;">&nbsp;</div>
    		<div style="width: 30%;background-color: #00ef76;max-height: 3px;float: left;">&nbsp;</div>
