...
<div class="popup write-review" style="width:510px !important;">
	...
	<div class="contact-seller-content">
			...
			<div style="padding-left: 120px; padding-top: 8px;">
		...
		<div class="cs-element">
			...
			<textarea id="review" maxlength="250" rows="8"></textarea>
			<div id="err_txt"></div>
		</div>
				...
				<input type="hidden" id="uname" value="'.$loguser[0]['User']['username'].'">
					<button class="btn-save" onclick="review('.$item_datas['User']['id'].','.$loguser[0]['User']['id'].')">Submit</button>';
					?>
        	</div>
