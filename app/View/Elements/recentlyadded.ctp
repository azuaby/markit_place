<div class="recntlyaddedcontainer widgetcontainer">
		...
		<?php 
		if ($recentlyaddedwidgettype == 'regular'){
			$type = 'widgetimgcont';
		}else{
			$type = 'darkwidgetcont';
		}
		...
		<div class="recntlyhead widgethead">
			<div class="subhead">Recently Added</div>
			<div class="seemore">
				<a href="<?php echo SITE_URL?>viewmore/recent" title="View More">View More</a>
			</div>
		</div>
		<div class="recntlycnt <?php echo $type; ?>">
			<ul>
				<?php foreach ($recentlyaddedModel as $recentlyadded) {?>
				<li>
