...
<div id="notification-bar" class="top after">
		...
		<div class="inner">
			<div id="navigation-test">
				...
				<div class="centered" style="width:45%;">
				<?php } else {?>
					...
					<ul class="fantaci-wrap">
						<li class="fantaci">
							...
							<div class="menu-contain-gift">
								...
								<ul>
									<li><a href="<?php echo SITE_URL; ?>price/"><?php echo __('By Price'); ?><i class="glyphicons chevron-right subheadarrdwn" style="text-indent:25px;"></i></a>
									...
									<li><a href="<?php echo SITE_URL; ?>color/" class="color-red"><?php echo __('By color'); ?><i class="glyphicons chevron-right subheadarrdwn" style="text-indent:26px;"></i></a>
									...
									<li><a href="<?php echo SITE_URL; ?>shop/browse/"><?php echo __('By Category'); ?><i class="glyphicons chevron-right subheadarrdwn" style="text-indent:14px;"></i></a>
						 ...
						 <li class="fantaci">
							...
							<div class="menu-contain-gift">
								<ul>
								<?php foreach ($forexrateModel as $forexrate){ ?>
									<li class="">
						...
						<?php } */	?>	
						<li class="fantaci">
							<a href="<?php echo SITE_URL; ?>help" class="mn-gifts glyphicons " title="<?php echo __('Help');?>" ><?php echo __('Help');?><i class="glyphicons chevron-right headarrdwn"></i></a>
							<div class="menu-contain-gift">
								<ul>
									<li class="">
            	...
            	<?php echo $this->Html->link(' ', array('language'=>'eng'), array('class'=>'mn-signin  glyphicons globe_af','title'=>'Language'));  ?>
							<div class="menu-contain-gift">
								<ul>
									<li class="">
										<a href="<?php echo SITE_URL; ?>eng/users/index" >English</a>
									</li>
									<li class="">
										<a href="<?php echo SITE_URL; ?>fra/users/index" >Français</a>
									</li>
									<li class="">
										<a href="<?php echo SITE_URL; ?>deu/users/index" >Deutsch</a>
									</li>
									<?php /* ?>
									<li class="">
									...
									<li class="">
									<?php echo $this->Html->link('Français', array('language'=>'fra')); ?>
									</li> 
									<li class="">
									<?php echo $this->Html->link('Deutsch', array('language'=>'deu')); ?>
									</li>
									<? php */ ?>
								</ul>
							</div>
					...
					?>
						...
						<!--li class="fantaci"><a href="<?php echo SITE_URL; ?>create/item" class="mn-add">Add</a></li-->    
                         ...
                         <li class="fantaci"><a href="#" onclick="itemadd()" class="mn-add" title="<?php echo __('Add'); ?>"><i class="glyphiconsheader plus" style="padding:0;"></i><?php echo __('Add'); ?></a></li>   
	...
	<!--    sathish for notification  -->
			...
			//echo "<pre>";print_r($logedvalues);die;
								...
								echo '</a>';
							echo '<div class="feed-notification" id="feed" style="display: none;width:350px;margin-left:-180px;height:320px;">';
				...
				?>			
					...
					echo '<a href="'.SITE_URL.'people/'.$username_url.'" class="mn-gifts">You <img src="'.$_SESSION['media_url'].'media/avatars/thumb70/'.$usrrrImg.'" width="35px" height="35px" style="margin: -14px 5px;'.$roundProf.'" /></a>'; 
					...
					?>
						...
						<span class="blue totalItemsCart"  style="margin-right:6px;"><?php echo $total_itms; ?> item(s)</span></a>
		...
		<div class="fromweb">
			...
			<div class="dbodyim">
				...
				<input id="givenlink" class="input-text" type="text" placeholder="http://">
					...
					<textarea id="additems_notes" placeholder="<?php echo __('Say something about this');?>" maxlength="200"></textarea>
			</div>
...
<!-- /popups -->
	...
	<div class="footercont">
		<div class="footermain">
			<div class="footersub">
				<div class="footersubhead">Company</div>
			...
			<div class="footersub">
				<div class="footersubhead">Help</div>
				<div class="footersubcont">
					<ul>
						<li>Contact us</li>
						<li>Track Orders</li>
			...
			<div class="footersub">
				<div class="footersubhead">Quick Links</div>
				<div class="footersubcont">
					<ul>
						<li>My Account</li>
						<li>My Cart</li>
			...
			<div class="footersublast">
				<div class="footersubhead">NewsLetter</div>
				<div class="newsletterhead">Signup for Social Offer and Updates</div>
				<div class="newsletterinputcont">
					<input type="text" class="newsletteremail" value="" placeholder="Enter Your Email Address">
					<button class="submitnewsletter">Join</button>
				</div>
			</div>
			<div class="footersubpayment">
				<div class="footersubpaymentcont">
					<ul>
						<li><img src='<?php echo SITE_URL; ?>images/footermastro.png' alt='Mastro'/></li>
						<li><img src='<?php echo SITE_URL; ?>images/footervisa.png' alt='Visa'/></li>
						<li><img src='<?php echo SITE_URL; ?>images/footeramerican.png' alt='American Express'/></li>
						<li><img src='<?php echo SITE_URL; ?>images/footerpaypal.png' alt='PayPal'/></li>
					</ul>
				</div>
			</div>
			<div class="footersubsocial">
				<div class="footersubsocialcont">
					<ul>
						<li><img src='<?php echo SITE_URL; ?>images/footerfb.png' alt='Facebook'/></li>
						<li><img src='<?php echo SITE_URL; ?>images/footertwitter.png' alt='Twitter'/></li>
						<li><img src='<?php echo SITE_URL; ?>images/footeryoutube.png' alt='You tube'/></li>
						<li><img src='<?php echo SITE_URL; ?>images/footerflicr.png' alt='Flicr'/></li>
						<li><img src='<?php echo SITE_URL; ?>images/footerpinterest.png' alt='Pinterest'/></li>
						<li><img src='<?php echo SITE_URL; ?>images/footergoogle.png' alt='Pinterest'/></li>
					</ul>
				</div>
			</div>
		</div>
		<div class="footerbotm">
			<div class="copyrights">
				&copy; Copyrighted by fancyclone.net 2014, All Rights Reserved
			</div>
		</div>
	</div>
	...
	<!-- <div id="footer-container">
		...
		<span class="poweredby">
			<?php echo __('Powered by'); ?> <a href="http://www.simplit.co" target="_blank">Simpl!t Co.</a>
		</span>
	</div> -->
