...
<div class="container set_area" style="width:940px;">
    <div id="content"  style="float:right;">
        ...
        <div class="markshippedcontent">
        	<div class="markshiphead"><?php echo __('Conversation with buyer');?> (<?php echo $buyerName; ?>)</div>
        	...
        	<div class="contactbuyer">
        		...
        		<div class="sellercommandarea">
        			...
        			<div class="sellercommandcont">
        				...
        				<button class="sellerpostcomntbtn" onclick="return postordersellercomment();" style="margin-right: 0px;"><?php echo __('Send ');?></button>
