<div class="container set_area" style="width:940px;">
        ...
        <div class="markshiphead" style="font-size:14px; margin-bottom: 14px;">
        	...
        	<span class="myordertimeline"> (<?php echo __('Sales History');?>)</span>
        	<div class="viewoldorder"><a href="<?php echo SITE_URL;?>orders" title="view recent orders"><?php echo __('View recent orders');?></a></div>
        </div>
...
/*$(document).live('click',function(){
	$('.moreactionlistmyord').slideUp('fast');	
});*/
</script>
...
<script type="text/javascript">
	...
	function loadmorecommentoldorders(upid){
		...
		if (loadmoreajax == 1 && loadmore == 1){
			loadmoreajax = 0;
			$.ajax({
				url: baseurl+'getmoreoldorderseller',
				type: 'POST',
				dataType: 'json',
