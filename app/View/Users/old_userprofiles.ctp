...
?>
		...
		echo "<div class='leftclas'>";
			...
			echo "<div class='profilImgName'>";
				...
				echo "<div class='profilImgName2'>@".$usernameforpro."</div>";
				echo "<div class='profilImgName3about'>".$shop_address."</div>";
				echo "<div class='profilImgName3about'>".$about."</div>";
				echo "<div class='profilImgName3about'>".$website."</div>";
			echo "</div>";
		echo "</div>";
		...
		echo "<div class='rightclas'>";
			...
			if($userid != $usr_datas['User']['id']){
				...
				if($userid != $usr_datas['User']['id']){
					...
					if($flw){
						...
						echo '<span class="foll'.$usr_datas['User']['id'].'" >Follow</span>';
						echo '</button>';
						echo "</div>";
						echo "</span>";
					}else{
				...
				echo "<div class='profilImgName'>";
				echo "<a href='".SITE_URL."settings' class='editPrfcls'><div class='editPrfclsfnt'> Edit profile </div></a>";
				echo "</div>";
			}
			//echo "<div class='profilImgName'>";
			...
			//echo "</div>";
			echo "<div class='profilImgName'>";
				echo "<a href='".SITE_URL.'people/'.$_SESSION['username_urls']."?following' class='contctLis'><span class='followCnts'>".count($followcnt)." </span> Following </a>";
			echo "</div>";
			echo "<div class='profilImgName'>";
				echo "<a href='".SITE_URL.'people/'.$_SESSION['username_urls']."?followers' class='contctLis'><span class='followCnts'>".count($flwrscnt)."</span> Follower </a>";
			echo "</div>";
		...
		echo '<div>';
			echo '<ul class="feedsandtrent">';
				...
				echo "<a href='".SITE_URL.'people/'.$_SESSION['username_urls']."'> ".$favitemCount." Products </a>";
				...
				echo "<a href='".SITE_URL.'people/'.$_SESSION['username_urls']."?lists'>".count($itemListsAll)." Lists </a>";
				echo '</li>';
				...
				echo "<a href='".SITE_URL.'people/'.$_SESSION['username_urls']."?added'> ".$item_datas_count." Added </a>";
				echo '</li>';
				...
				echo "<a href='".SITE_URL.'people/'.$_SESSION['username_urls']."?wantit'>".$wantCount." Want it </a>";
				echo '</li>';
				...
				echo "<a href='".SITE_URL.'people/'.$_SESSION['username_urls']."?ownit'>".$ownCount." Own it </a>";
				echo '</li>';
				...
				if(isset($usr_datas['Shop']['shop_latitude']) && isset($usr_datas['Shop']['shop_longitude'])){
					...
					if($userid == $usr_datas['User']['id']){
						...
						echo "<a href='".SITE_URL.'people/'.$_SESSION['username_urls']."?news'>News </a>";
						echo '</li>';
					...
					if($userid == $usr_datas['User']['id']){
						...
						echo "<a href='".SITE_URL.'people/'.$_SESSION['username_urls']."?userapprove'>User Fashion</a>";
						echo '</li>';
		...
		<div class="wrapper-content profile-content"><br />
		<?php
		...
		<?php if(isset($_REQUEST['added'])){
					...
					//print_r($flwrscnt);
					?>
					<?php 	echo '<div class="figure-product figure-200"  id="addeitem_'.$itemsd['Item']['id'].'" >';?>
