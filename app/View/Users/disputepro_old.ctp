...
<div class="container set_area" style="width:940px;">
		...
		echo "<a href='".SITE_URL.'dispute/'.$_SESSION['first_name']."?buyer' >Send </a>";
		echo '</li>';
				...
				echo "<a href='".SITE_URL.'dispute/'.$_SESSION['first_name']."?seller' >Receive </a>";
				echo '</li>';
			echo '</ul>';
		...
		$selectedTab = 'buyer';
				 ...
				 if (!empty($messagesel)){
					...
					<thead>
	        			<tr>
		        			<td style="font-size: 15px;font-weight:bold;" >Product Name</td>
		        			<td style="font-size: 15px;font-weight:bold;">Order Id</td>
		        			<td style="font-size: 15px;font-weight:bold;">Order Problem</td>
		        			<td style="font-size: 15px;font-weight:bold;">Message</td>
		        			<td style="font-size: 15px;font-weight:bold;">Actions</td>
		        		</tr>
        			</thead>
		...
		<tr>	
          ...
          <td style="width: 180px;text-align:left; padding: 0 0 0 17px;height:40px;">  <?php echo $msrc;?></td>
           ...
           <td style="width:150px;text-align:left;padding: 0 0 0 20px;height:40px;"><?php echo $msrd;?></td>
       ...
       <td style="width:100px;text-align:left;padding:0 0 0 10px;height:40px;">  <a href="<?php echo SITE_URL; ?>disputemessage/<?php echo $msro;?>" class="first" style="padding: 0 0 0 13px;"><i class="ic-pur"></i> <?php  echo __('View'); ?></a>
				...
				<?php if (count($messagesel) > 10) {?>
					...
					<?php 
        					...
        					echo "<div class='noordercmnt' style='text-align:center;font-size:12px;font-weight:bold;'>No Conversation Found</div>";
	...
	<?php $dot="..."?>
        ...
        <td style="width: 180px;text-align:left; padding: 0 0 0 15px;"><?php echo $msrcbuy;?></td>
           ...
           <td style="width:150px;text-align:left;padding: 0 0 0 19px;"> <?php echo $msrdbuy;?></td>
