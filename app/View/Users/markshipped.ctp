<div class="container set_area" style="width:940px;">
    <div id="content"  style="float:right;">
        ...
        <div class="markshippedcontent">
        	<div class="markshiphead"><?php echo __('Mark as Shipped');?></div>
        	...
        	<div class="markshipemailcont">
        		...
        		<div class="trackinginput">
        			<input type="text" name="subject" id="emailsubject" style="width: 97.5%;" value="" />
        			<div class="emailsubjecterror error"></div>
        		</div>
        		<p class="trakinglabel">
        			<?php echo __('Message');?>: &nbsp;&nbsp;
        		</p>
        		<div class="trackinginput">
        			<textarea rows="10" cols="15" id="emailmessage" style="width: 97.5%;"></textarea>
        			<div class="emailmessageerror error"></div>
        		</div>
        		<!-- <p class="emailsub">
        			Subject: &nbsp;&nbsp;
        			<input type="text" name="subject" id="emailsubject" value="" />
        			<div class="emailsubjecterror error"></div>
        		</p>
        		<p class="emailsub">
        			Message: 
        			<textarea rows="10" cols="15" id="emailmessage"></textarea>
        			<div class="emailmessageerror error"></div>
        		</p> -->
        		<div class="markshipbtn">
        			<div class="markshipbtnloader">
        				<img src="<?php echo SITE_URL; ?>images/loading.gif" alt="Loading..." />
        			</div>
        			<button class="markshippedbtn" onclick="return markshipped();"><?php echo __('Mark as Shipped');?></button>
