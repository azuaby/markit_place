<div class="container set_area" style="width:940px;">
        ...
        <h2 class="ptit"><?php echo __('Dispute As Buyer'); ?></h2>
        <div class="figure-row" style="padding: 20px 13px 18px;">
	...
	<div class="sellerimg">
        		...
        		<div class="sellercommandcont">
        				...
        				<?php echo $this->Form->create('Dispute', array( 'id'=>'disputeform','onsubmit'=>'return rlyadmsg()')); ?>
        				 ...
        				 <?php
			echo $this->Form->submit(__('Send '),array('class'=>'sellerpostcomntbtn', 'div'=>false,'name'=>'buyconver','style'=>'margin-right: 0px;'));
		echo $this->Form->end();
...
?>    				 
		...
		<?php
					...
					//$ro = $msg['msid'];
						 ?>
						<!--  <div class="cmntcontnr" style=" margin-left: -7px;margin-bottom: 15px;padding: 0px 0px 0px 10px; width:700px;">						
						 <div class="usrimg"> -->
				...
				<?php }elseif ($msrc == 'Seller') {?>	
					...
					<!-- <div class="cmntcontnr" style="text-align: right;margin: 0px 12px 0 0;border-radius: 4px;margin-bottom: 15px;">
